...
class SelectQuery(baseclasses.HasWhereQueryBase):
...
class UpdateQuery(baseclasses.HasToSetQueryBase, baseclasses.HasWhereQueryBase):
...
class InsertQuery(baseclasses.HasToSetQueryBase):
    def __init__(self, setDict=None, table=None) -> None:
        super().__init__(table=table, setDict=setDict)
...
class DeleteQuery(baseclasses.HasWhereQueryBase):
